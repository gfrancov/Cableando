...
function cableando_register_styles() {
    ...
    wp_enqueue_style('cableando-bootstrap', "https://cdn.jsdelivr.net/npm/bootstrap@4.0.0/dist/css/bootstrap.min.css", array(), '3.3.7', 'all');
...
function cableando_register_scripts() {
    ...
    wp_enqueue_script('cableando-popper', "https://cdn.jsdelivr.net/npm/popper.js@1.12.9/dist/umd/popper.min.js", array(), "2.1.3", true);
    wp_enqueue_script('cableando-bootstrapjs', "https://cdn.jsdelivr.net/npm/bootstrap@4.0.0/dist/js/bootstrap.min.js", array(), "2.1.3", true);
